...
- `PROC`内では匿名シンボルとして`@@, @0-@9`が使用可能です。
- `@@, @0-@9`は定義専用のシンボルで`PROC`内で複数定義可能です。
- `@F, @0F-@9F`は参照専用のシンボルで、記述位置より前方（下行方向）にある直近の`@@, @0-@9`を参照します。
- `@B, @0B-@9B`も参照専用のシンボルで、記述位置より前方（上行方向）にある直近の`@@, @0-@9`を参照します。
